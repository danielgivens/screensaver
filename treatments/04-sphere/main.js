...
const NUM_IMAGES     = 230      // how many planes to place on the sphere
...
async function buildScene() {
  const positions = fibonacciSphere(NUM_IMAGES, SPHERE_RADIUS)
...
function applyCameraRotation() {
  ...
  camera.position.set(0, 0, 0)
  // Camera looks outward from center — target point on sphere surface
